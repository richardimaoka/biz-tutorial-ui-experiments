...
func TestFileNode_MutateDirectory(t *testing.T) {
	...
	internal.CompareAfterMarshal(t, "testdata/source_code/file-node-mutation1.json", result)
...
func TestFileNode_MutateFile(t *testing.T) {
	...
	result := processor.fileMap["hello/world"].ToGraphQLNode()
	internal.CompareAfterMarshal(t, "testdata/source_code/file-node-mutation2.json", result)
...
func TestFileNodeOpenFile_MutateFile(t *testing.T) {
	...
	internal.CompareAfterMarshal(t, "testdata/source_code/file-node-mutation-openfile1.json", result)
