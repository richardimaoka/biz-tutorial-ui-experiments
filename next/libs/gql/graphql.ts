...
export type PageColumns2FragmentFragment = {
  __typename: "Page";
  focusColumn?: string | null;
  step?: string | null;
  columns?: Array<
  ...
  modal?:
    ...
    | null;
} & { " $fragmentName"?: "PageColumns2FragmentFragment" };
...
export const PageColumns2FragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
...
} as unknown as DocumentNode<PageColumns2FragmentFragment, unknown>;
