...
export type TerminalElement = TerminalCommand | TerminalCommandSet | TerminalOutput;
...
export type TerminalCommand_FragmentFragment = { __typename: 'TerminalCommand', command?: string | null } & { ' $fragmentName'?: 'TerminalCommand_FragmentFragment' };
